    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < cars.length; i++) {
            ...
            if (cars[i].contains("Civic")) {
                System.out.println("index of Civic = " + i);
                countofCivic++;
            }
            System.out.println("countChev = " + countChev);
            System.out.println("countofCiviv = " + countofCivic);
            System.out.println("Civic found at location) = " + i);
            System.out.println();
        }
        // Task2 : print all location of Honda-Civic in this array
...
//                        " Car model is " + eachCarSplitted[1]);
        ...
        for (String eachCar : cars) {
                ...
                if(model.length() == 2){
                    System.out.println(model);  // you can print model also. you just get two characters
                    cntOf2CharModel++;
                }
        }
        ...
        // what if I want a incase sensivity
//        int checvyCNT = 0;
//        int civicCNT = 0;
//        for (  String eachCar : cars){
...
//              }
//        }
//        System.out.println("checvyCNT = " + checvyCNT);
