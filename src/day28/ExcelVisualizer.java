...
public class ExcelVisualizer {
    ...
    public static void main(String[] args) {
       ...
       // to store this in another array object
        // this is one way to store 2D
       //int[][] row = { {78, 54, 100, 84}, {33,44,77,123} , {12,88,52,76},
       //                {67, 33, 98, 67}  , {12, 88, 52, 45}  , {67, 33, 98, 34} };
        ...
        int[][] myExcel = {    {  10 , 7 } , {  87, 99, 100 } , { 90 , 45 }    };
        ...
        // in this 2D array array object , we have 3 ONE dimensional array object stored
        // object count = array object count
        System.out.println(myExcel.length);   // 3 single arrays
