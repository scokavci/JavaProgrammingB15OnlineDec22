...
//        Hint : first count toyota to find out your new array size then fill it up with toyota cars
        ...
        String[] toyotaInventory = new String[53];
        String assignToyota = "";

            for (int j = 0; j < cars.length; j++) {
                if (cars[j].contains("Toyota")) {
                   assignToyota += cars[j]+",";
                }
            }
        String[] toyotaInventory1 = assignToyota.split(",");
        System.out.println( Arrays.toString(toyotaInventory1) );
    }
}
